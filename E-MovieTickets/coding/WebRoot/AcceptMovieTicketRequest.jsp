  ...
  <body>
    <%
      ...
      if(status.equals("pending")){
         ...
         boolean flag=bookingDAO.acceptMovieRequest(bid);
         if(flag)
             response.sendRedirect("ViewMovieTicketRequests.jsp?status=accepted");
         else
            response.sendRedirect("ViewMovieTicketRequests.jsp?status=accepting failure");
      }else{
