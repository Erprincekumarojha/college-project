																			...
																			<tbody>
																				<tr>
																					...
																					<td valign="top" width="631" align="left"
																						...
																						<br/><br/>
																						<center>
																						<font color="white" size="3">Theatres Registration
																						</font>
																						</center>
																						<%
																						 ...
																						 <%} %>
																						 <form name="theatreform" action="./TheatreAction">
																						   <table align="center" >
																						      <tr>
																						         <td>TheatreName</td>
																						       ...
																						       <tr>
																						         <td>Noofshows</td>
																						         <td><input type="text" name="nofshows" /></td>
																						       </tr>
																						       <tr>
																						         <td>NoofSeats</td>
																						       ...
																						       <tr>
																						         <td><input type="submit" value="RegisterTheatre"></td>
...
//You should create the validator only after the definition of the HTML form
  var frmvalidator  = new Validator("theatreform");
  
 
  frmvalidator.addValidation("tname","req","Please enter Theatre Name");
  frmvalidator.addValidation("tname","maxlen=20",	"Max length for tname is 20");
  frmvalidator.addValidation("tname","alpha"," tname Alphabetic chars only");
  ...
  frmvalidator.addValidation("pin","req","Please enter pin");
 ...
 frmvalidator.addValidation("phoneno","Phone");
  ...
  frmvalidator.addValidation("nofshows","req","Please enter nofshows");
  
  frmvalidator.addValidation("noofseats","req","Please enter noofseats");
