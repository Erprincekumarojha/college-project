																			...
																			<tbody>
																				<tr>
																					...
																					<td valign="top" width="631" align="left"
																						...
																						<br/><br/>
																						<center>
																						<font color="white" size="3"><%=(String)session.getAttribute("username") %> Booking Tickets Status
																						</font>
																						</center>
																						<%
																						  ...
																						  ArrayList<TheatreBean> bookingTicketList=bookingDAO.viewBookingTicketsbyUser(uid);
																						  if(bookingTicketList.size()!=0){
																						 %>
																						 ...
																						 <tr>
																						   ...
																						   <%
																						     for(TheatreBean theatreBean:bookingTicketList){
																						    %>
																						    <tr>
