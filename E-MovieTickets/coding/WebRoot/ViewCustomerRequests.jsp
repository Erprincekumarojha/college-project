																			...
																			<tbody>
																				<tr>
																					...
																					<td valign="top" width="631" align="left"
																						...
																						<br/><br/>
																						<center>
																						<font color="white" size="3">View Customer Requests
																						</font>
																						</center>
																						<%
																						   String storepath=request.getRealPath("/images");
																						   UserMasterDAO userMasterDAO=new UserMasterDAO();
																						   ArrayList<UserMasterBean> customerList=userMasterDAO.viewCustomerRequests(storepath);
																						...
																						<table align="center" border="1">
																						       ...
																						       <td>Status</td>
																						        ...
																						        <%
																						           for(UserMasterBean userMasterBean:customerList){
																						         %>
																						         <tr>
																						         <td><%=userMasterBean.getUsername() %></td>
																						         ...
																						         <td><a href="AcceptRequest.jsp?userid=<%=userMasterBean.getUserid() %>&status=<%=userMasterBean.getStatus() %>" ><%=userMasterBean.getStatus() %></a></td>													
																						        <%} %> 									         
																						</table>
																						<%} else { %>
																						 <font color="yellow"> Sorry , No Pending Requests for processing</font>
																						<%} %>
																					</td>
																					<td valign="top" align="left">
																						&nbsp;
