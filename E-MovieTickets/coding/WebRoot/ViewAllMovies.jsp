																			...
																			<tbody>
																				<tr>
																					...
																					<td valign="top" width="631" align="left"
																						...
																						<br/><br/>
																						 <center>
																						<font color="white" size="3">Movies Information
																						</font>
																						</center>
																						<%
																						   String storepath=request.getRealPath("/images");
																						   MoviesDAO moviesDAO=new MoviesDAO();
																						   ArrayList<MovieBean> moviesList=moviesDAO.getMoviesInfo(storepath);
																						 ...
																						 <table align="center" border="1">
																						    ...
																						    <%
																						     ...
																						     %>
																						    <tr><td><%=movieBean.getMoviename() %></td>
																						   <td><img src="images/<%=movieBean.getImage() %>" width="50" height="50"></img></td>
																						    <td><%=movieBean.getSynopsis() %></td>
																						    <td><%=movieBean.getReleasedate() %></td>
																						    <td><%=movieBean.getLanguage() %></td>
																						    <td><%=movieBean.getGenre() %></td>
																						    <td><%=movieBean.getHero() %></td>
																						    <td><%=movieBean.getHeroin() %></td>
																						    <td><%=movieBean.getVilan()%></td>
																						    <td><%=movieBean.getDirector() %></td>
																						    <td><%=movieBean.getMusic() %></td>
																						     <td><a href="Rating.jsp?mid=<%=movieBean.getMovieid() %>" ><%=movieBean.getRating() %></a></td>
																						    </tr>
																						    <%} %>
																						 </table>
																						 <%
