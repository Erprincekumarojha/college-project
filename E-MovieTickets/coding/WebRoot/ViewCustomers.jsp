...
<%@page import="com.kws.mtrs.dao.EmailsDAO"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.kws.mtrs.bean.EmailBean"%>
<%@page import="com.kws.mtrs.dao.NewsDAO"%>
<%@page import="com.kws.mtrs.bean.NewsBean"%>
<%@page import="com.kws.mtrs.dao.UserMasterDAO"%>
<%@page import="com.kws.mtrs.bean.UserMasterBean"%><!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html>
	<head>
																			...
																			<tbody>
																				<tr>
																					...
																					<td valign="top" width="631" align="left"
																						...
																						<center>
																						<font color="white" size="3"> Customers Information
																						</font>
																						</center>
																					    ...
																					    <%
																					      ...
																					      ArrayList<UserMasterBean> usersList=userMasterDAO.getCustomers(storepath);
																					       if(usersList.size()!=0){	
																					       %>
																					        ...
																					        <%
																					         ...
																					         %>
																					         <tr><td><%=userMasterBean.getUsername() %> </td>
																					       <td><%=userMasterBean.getAddress()  %></td>
																					      <td><%=userMasterBean.getCity()  %></td>
																					         <td><%=userMasterBean.getState()  %></td>
																					       <td><%=userMasterBean.getCountry()  %></td>
																					        <td><%=userMasterBean.getPhoneno()  %></td>
																					       <td><%=userMasterBean.getDob()  %></td>
																					      <td><%=userMasterBean.getDor()  %></td>
																					        <td><img src="images/<%=userMasterBean.getPhoto()  %>" width="50" height="50"></td></tr>
																					         <%} %>
																					      </table>
																					     
																					     <%}else{ %>
																					       Mail Records Not Found
																					     <%} %>
