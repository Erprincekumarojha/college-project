...
<%@page import="com.kws.mtrs.bean.NewsBean"%><!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html>
	<head>
																			...
																			<tbody>
																				<tr>
																					...
																					<td valign="top" width="631" align="left"
																						...
																						<center>
																						<font color="white" size="3"> News Info
																						</font>
																						</center>
																					    ...
																					    <%
																					      ...
																					      ArrayList<NewsBean> newsList=newsDAO.getNews();
																					       if(newsList.size()!=0){	
																					       %>
																					        <table align="center">
																					        <%
																					         ...
																					         %>
																					         <tr><td><%=newsBean.getNewsid()%>) <%=newsBean.getNewsheading() %> --- <%=newsBean.getNewsPostedDate() %> </td></tr>
																					         <tr><td><%=newsBean.getNewsdetails()  %></td></tr>
																					         <%} %>
																					      </table>
