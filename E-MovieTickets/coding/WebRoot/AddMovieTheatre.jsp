...
<%@page import="com.kws.mtrs.dao.TheatreDAO"%><!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html>
	<head>
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="0">
											<tbody>
												<tr valign="middle" align="center">
													...
													style="font-size: 20px; font-weight: bold; color: White; margin-bottom: 0px; margin-top: 0px; text-align: center;"><jsp:include page="AdminOptions.jsp"></jsp:include>
													<br /></td>
												</tr>
												<tr>
													<td valign="top" align="left"
																			...
																			<tbody>
																				<tr>
																					...
																					<td valign="top" width="631" align="left"
																						...
																						<br/><br/>
																						<center>
																						<font color="white" size="3">Movies - Theatres
																						</font>
																						</center>
																						<%
																						  String noofshows=request.getParameter("noshows");
																						  int showsno=new Integer(noofshows).intValue();
																						  System.out.println("showno:"+showsno);
																						  
																						  int tid=Integer.parseInt(request.getParameter("tid"));
																						  int showcount=new TheatreDAO().getnoShows(tid);
																						  if(showsno>showcount){
																						 %>
																						<form name="movietheatres" action="./MovieTheatresAction">
																						<table align="center">
																						   ...
																						   <%
																						     ...
																						     ArrayList<MovieBean> movieList=moviesDAO.getMovies();
																						     for(MovieBean movieBean:movieList){
																						    %>
																						    <option value="<%=movieBean.getMovieid() %>"><%=movieBean.getMoviename() %></option>
																						    <%} %>
																						   </select>
																						   </td></tr>
																						   <tr>
																						      <td>Timings</td>
																						      <td><input type="text" name="timings" />
																						    </td>
																						   </tr>
																						   <tr>
																						      <td>TicketPrice</td>
																						   ...
																						   <tr>
																						      <td><input type="submit" value="AddMovieTheatre" /></td>
																						...
																						<%}else{
																						   response.sendRedirect("ViewTheatres.jsp?status=Providing Shows To Theatre Completed"); 
																						%>
				...
				<tr>
					<td colspan="2">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							...
							<tbody>
								<tr>
									<td width="200" align="center" background="images/foot-bg.jpg">m
