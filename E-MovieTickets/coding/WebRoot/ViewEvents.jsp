...
<%@page import="com.kws.mtrs.dao.EventDAO"%>
<%@page import="com.kws.mtrs.bean.EventsBean"%><!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html>
	<head>
																			...
																			<tbody>
																				<tr>
																					...
																					<td valign="top" width="631" align="left"
																						...
																						<center>
																						<font color="white" size="3"> Events Info
																						</font>
																						</center>
																					    ...
																					    <%
																					      ...
																					      ArrayList<EventsBean> eventList=eventDAO.getEvents();
																					        if(eventList.size()!=0){
																					       %>
																					        <table align="center">
																					        <%
																					         ...
																					         %>
																					         <tr><td><%=eventsBean.getEventid()%>) <%=eventsBean.getEventname() %> </td></tr>
																					         <tr><td><%=eventsBean.getEventdesc()  %></td></tr>
																					         <%} %>
																					      </table>
				...
				<tr>
					<td colspan="2">
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							...
							<tbody>
								<tr>
									<td width="200" align="center" background="images/foot-bg.jpg">e
