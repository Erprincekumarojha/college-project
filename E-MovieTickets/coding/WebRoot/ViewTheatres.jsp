																			...
																			<tbody>
																				<tr>
																					...
																					<td valign="top" width="631" align="left"
																						...
																						<br/><br/>
																						 <center>
																						<font color="white" size="3">Theatres Information
																						</font>
																						</center>
																						<%
																						...
																						<%} %>
																						 ...
																						 <table align="center" border="1">
																						    ...
																						    <%
																						     ...
																						     %>
																						    <tr><td><%=theatreBean.getTheatrename() %></td>
																						   
																						    <td><%=theatreBean.getCity() %></td>
																						    <td><%=theatreBean.getState() %></td>
																						    <td><%=theatreBean.getCountry() %></td>
																						    <td><%=theatreBean.getPin() %></td>
																						    <td><%=theatreBean.getPhone() %></td>
																						    <td><%=theatreBean.getEmail() %></td>
																						    <td><%=theatreBean.getNoofshows()%></td>
																						    <td><%=theatreBean.getNoofseats() %></td>
																						    <td><a href="AddMovieTheatre.jsp?tid=<%=theatreBean.getTheatreid() %>&noshows=<%=theatreBean.getNoofshows() %>" >AddMovie</a>
																						    <%} %>
																						 </table>
																						 <%
																						 
																						 }else{ %>
																						    Sorry , Theatre records not found
																						 <%} %>
																					</td>
																					<td valign="top" align="left">
																						&nbsp;
