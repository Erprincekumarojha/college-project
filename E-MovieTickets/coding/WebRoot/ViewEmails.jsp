...
<%@page import="com.kws.mtrs.bean.EmailBean"%><!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
<html>
	<head>
																				...
																				<tr>
																					...
																					<td valign="top" width="631" align="left"
																						...
																						<%
																						  ...
																						  %>
																						<center>
																						<font color="white" size="3"><%=username %> Emails
																						</font>
																						</center>
																					    ...
																					    <%
																					      ...
																					      ArrayList<EmailBean> emailsList=emailsDAO.viewEmails(uid);
																					     ...
																					     <%
																					       for(EmailBean emailBean:emailsList){
																					      %>
																					     <tr>
																					       <td><%=emailBean.getSendername() %></td>
																					       <td><%=emailBean.getSubject() %></td>
																					       <td><%=emailBean.getSenddate() %></td>
																					       <td><%=emailBean.getMaildesc() %></td>
																					       </tr>
																					       <%} %>
																					     </table>
																					     <%}else{ %>
