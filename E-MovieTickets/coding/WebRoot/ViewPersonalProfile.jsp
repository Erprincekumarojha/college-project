																				...
																				<tr>
																					...
																					<td valign="top" width="631" align="left"
																						...
																						<%
																						 ...
																						 %>
																						<center>
																						<font color="white" size="2"><%=username %> Personal Profile
																						</font>
																						</center>
																						<%
																						  ...
																						  UserMasterBean userMasterBean=userMasterDAO.getPersonalProfile(uid,storepath);
																						  
																						  if(userMasterBean!=null){
																						  %>
																						  <table align="center">
																						   <tr><td>Dob</td><td>:<%=userMasterBean.getDob() %></td></tr>
																						   <tr><td>Dor</td><td>:<%=userMasterBean.getDor() %></td></tr>
																						   <tr><td>Address</td><td>:<%=userMasterBean.getAddress() %></td></tr>
																						   <tr><td>City</td><td>:<%=userMasterBean.getCity() %></td></tr>
																						   <tr><td>Phoneno</td><td>:<%=userMasterBean.getPhoneno() %></td></tr>
																						   <tr><td>Photo</td><td>:<img src="images/<%=userMasterBean.getPhoto() %>"></td></tr>
																						  </table>
																						<%} %>
																					</td>
																					<td valign="top" align="left">
