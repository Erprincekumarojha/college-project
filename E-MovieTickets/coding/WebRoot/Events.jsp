																			...
																			<tbody>
																				<tr>
																					...
																					<td valign="top" width="631" align="left"
																						...
																						<br/><br/>
																						<center>
																						<font color="white" size="3">Events Posting Form
																						</font>
																						</center>
																						<%
																						 ...
																						 <%} %>
																						 <form name="eventForm" action="./EventsAction">
																						 <table align="center">
																						     <tr>
																						        <td>EventName</td>
																						     ...
																						     <tr>
																						        <td>EventDesc</td>
																						        <td><input type="text" name="eventDesc" />
																						     </tr>
																						     <tr>
																						        <td><input type="submit" value="PostEvents"></td>
