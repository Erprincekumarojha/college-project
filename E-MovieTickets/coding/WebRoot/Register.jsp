																			...
																			<tbody>
																				<tr>
																					...
																					<td valign="top" width="631" align="left"
																						background="images/green-box.jpg" height="400">


																						<br/><br/>
																						<center>
																						<font color="white" size="3">Registration Form
																						</font>
																						</center>
																					<%
																					...
																					<form name="register" action="./RegisterAction">	
																						<table align="center">
																							
																							 <input type="hidden" name="logintype" value="<%=lt %>" />
...
//You should create the validator only after the definition of the HTML form
  ...
  frmvalidator.addValidation("uname","maxlen=20",	"Max length for uname is 20");
  frmvalidator.addValidation("uname","alpha"," uname Alphabetic chars only");
  
  frmvalidator.addValidation("upass","req","Please enter password");
  frmvalidator.addValidation("upass","maxlen=20","Max length is 20");
  frmvalidator.addValidation("upass","alpha"," password Alphabetic chars only");
  ...
  frmvalidator.addValidation("country","req","Please enter country");
   ...
   frmvalidator.addValidation("phno","req");
  
  frmvalidator.addValidation("phno","maxlen=50");
 ...
 frmvalidator.addValidation("phno","Phone");
  ...
  frmvalidator.addValidation("photo","req","Please Load ur Photo");
   frmvalidator.addValidation("squestion","dontselect=0");
   frmvalidator.addValidation("sanswer","req","Please enter your sanswer");
