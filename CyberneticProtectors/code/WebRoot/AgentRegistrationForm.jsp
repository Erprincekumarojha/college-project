...
window.location.href='http://'+host+':'+port+'/Cybernatic/CheckUserAction?userName='+userName+"&path=./RegistrationForm.jsp";
} 
</script>
		<style type="text/css">
.Title {
				...
				<tr>
					...
					<td width="276">
						<select name="logintype" onChange="cleartext()">
							...
							<option value="DefenceMinistry">
								<font size="3" face="Verdana">DefenceMinistry</font>
							</option>
						</select>
					</td>
				<tr>
