	...
	<form action="./AddAgencyAction" name='case' method="get">
		...
		<table border='0' align="center">
			...
			<tr>
				...
				<td>
					<input type="text" name="agencyname" value="" required/>
				</td>
			</tr>
			<tr>
				<td align='right'>
				...
				<td>
					<textarea type="text" name="agencydescription" value="" required></textarea>
				</td>
			</tr>
			<tr>
				<td align='right'>
				...
				<td>
					<input type="text" name="agencyaddress" value="" size="20" required/>
				</td>
			</tr>
			<tr>
				<td align='right'>
				...
				<td>
					<input type="number" name="agencycontact" value="" size="20"  pattern=".{10,10}" required title="should be 10 digits"  /> 
				</td>
			</tr>
			<tr>
				<td align='right'>
