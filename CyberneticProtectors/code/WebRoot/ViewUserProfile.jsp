			...
			<form method='get' action="./UpdateUserProfileAction" name="register"
				...
				<table border='0' align="center">
					...
					<tr>
						...
						<td>
							<input type="email" name="email" value="<%=pro.getEmail()%>"
								size="20" />
						</td>
						<td>
					...
					<tr>
						...
						<td>
							<input type="number" name="phoneNo" value="<%=pro.getPhoneNo()%>"
								size="20" pattern=".{10,10}" required title="something" required/>
						</td>
						<td align='right'>
							Pin :
						</td>
