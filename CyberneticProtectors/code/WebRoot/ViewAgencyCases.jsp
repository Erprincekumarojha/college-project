...
<html>
	...
	<body>
		...
		<% String report="";
           ...
           report+=" <tr><td>CaseId</td><td>CaseName</td><td>AgencyName</td><td>CaseRegdate</td><td>Case Status</td></tr>"; 
	...
	report+= "<tr><td align='center'><b>"+r.getCaseid()+"</b></td><td align='center'><b>"+r.getCasename()+"</td><td align='center'><b>"+r.getAgencyname()+"</b></td><td align='center'><b>"+r.getCaseregdate()+"</b></td><td align='center'><b>"+r.getCasestatus()+"</b></td></tr>";
		}
		report+="</table>";
