...
<html>
	...
	report+= "<tr><td align='center'><b>"+r.getCaseassignid()+"</b></td><td align='center'><b>"+r.getCasename()+"</td><td align='center'><b>"+r.getAgencyname()+"</b></td><td align='center'><b>"+r.getCaseregdate()+"</b></td><td align='center'><b>"+r.getCasestatus()+"</b></td></tr>";
		}
		report+="</table>";
