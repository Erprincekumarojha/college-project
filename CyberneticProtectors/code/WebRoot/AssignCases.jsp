...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<!-- This is the form -->
		<form action="./AddAssignCaseAction" name='agency' method="get">
			<table border='0' align="center">
					...
					<td>
						<select name="caseid" id="select">
							...
							<c:if test="${not empty vcaseto2}">
								<c:forEach var="case" items="${vcaseto2}">
				...
				<tr>
					...
					<td>
						<select name="agencyid" id="select">
							<option>
								--SELECT--
							</option>
							<c:if test="${not empty vcaseto1}">
								<c:forEach var="agency" items="${vcaseto1}">
...
//You should create the validator only after the definition of the HTML form
  var frmvalidator  = new Validator("agency");
         ...
         frmvalidator.addValidation("caseid","dontselect=0");
            frmvalidator.addValidation("agencyid","dontselect=0");
  </script>
		<br></br>
		<br></br>
		<br></br>
