			...
			<form action="./RegisterAction" name="register" method='get'
				...
				out.print(request.getParameter("userName"));%>"
					...
					<tr>
						...
						<td>
							<input type="password" name="password"
								...
								onchange="Encrypt(document.forms.register.password.value);" required />
						</td>
						<td></td>
						<td></td>
					</tr>
					...
					<tr>
						...
						<td>
							<input type="password" name="conformpassword" value="" size="20"
								onBlur="checkconformpassword()"  required/>
						</td>
					...
					<tr>
						...
						<td>
							<input type="text" name="ownquest" disabled="disabled" size="37" required/>
						</td>
					</tr>
					<tr>
						<td align='right'>
						...
						<td>
							<input type="text" name="secrete" value="" size="20" required/>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<select name="gender">
								...
								<option value="Male">
									<font size="3" face="Verdana" checked>Male</font>
								</option>
								<option value="Female">
					...
					<tr>
						...
						<td>
							<input type="email" name="email" value="" size="20" required/>
						</td>
					</tr>
					<tr>
						<td align='right'>
						...
						<td>
							<input type="text" name="fax" value="" size="20" required/>
						</td>
					</tr>
					<tr>
						<td align='right'>
						...
						<td>
							<input type="file" name="photo" class="textfield"
								onChange="preview(this)" required />
						</td>
						<td></td>
						<td></td>
					</tr>
					<tr>
						...
						<tr>
							...
							<td>
								<input type="text" name="houseNo" value="" size="20" required/>
							</td>
							...
							<td width="273">
								<input type="text" name="district" value="" size="20" required/>
							</td>
						</tr>
						<tr>
							<td align='right'>
							...
							<td>
								<input type="text" name="street" value="" size="20" required/>
							</td>
							<td align='right'>
								State :
							</td>
						...
						<tr>
							...
							<td>
								<input type="text" name="country" value="" size="20" required/>
							</td>
						</tr>
						<tr>
							<td align='right'>
							...
							<td>
								<input type="number" name="phoneNo" value="" size="20"
									onBlur="ValidateForm()" pattern=".{10,10}" required title="10 charactes minimum"/>
							</td>
							<td align='right'>
								Pin :
							</td>
							<td>
								<input type="number" name="pin" value="" size="20"
									onChange="showStatus()" required />
							</td>
						</tr>
