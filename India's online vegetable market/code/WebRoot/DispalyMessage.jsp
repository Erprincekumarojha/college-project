...
<html>
  <head>
    ...
    <title>My JSP 'DispalyMessage.jsp' starting page</title>
  ...
  <body>
       ...
       rd.forward(request,response);   
          ...
          <br/><br/><br/>
          <label style="color: white; font-style:italic;"> <% String status=request.getParameter("status"); if(status!=null){out.println(status);} %></label>      
